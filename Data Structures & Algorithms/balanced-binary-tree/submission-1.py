...
class Solution:
    ...
    def isBalanced(self, root: Optional[TreeNode]) -> bool:
        ...
        if not root.left:
            ...
            # invariant: delta accurately represents delta b/w height of left and right subtree

            delta = abs(heightOfSubtree(root.left) - heightOfSubtree(root.right))

            # print(f"for root value: {root.val}, delta b/w {root.left.val} and {root.right.val} is {delta}")
